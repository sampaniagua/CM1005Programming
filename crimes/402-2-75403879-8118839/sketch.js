...
Officer: 8118839
CaseNum: 402-2-75403879-8118839
...
//West: detSpeedX = -1 and detSpeedY = 0
	if (det.locationX > 700)
	{
     ...
     else if (det.locationY == 123)
        {
            det.speedX = -1;
            det.speedY = 0;
        }
    else if (det.locationX == 185)
        {
            det.speedX = 0;
            det.speedY = -1;
        }

    else if (det.locationY == 246)
        {
            det.speedX = -1;
            det.speedY = 0;
        }
    else if (det.locationX == 436)
        {
            det.speedX = 0;
            det.speedY = -1;
        }
    else if (det.locationY == 433)
        {
            det.speedX = -1;
            det.speedY = 0;
        }
    else if (det.locationX == 687)
        {
            det.speedX = 0;
            det.speedY = -1;
        }
